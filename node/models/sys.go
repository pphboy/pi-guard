...
type NodeSys struct {
	NodeId     string     `gorm:"column:primaryKey;NODE_ID" json:"NodeId"` //type:string       comment:                             version:2024-02-16 19:36
...
type NodeSetting struct {
	SettingId      string     `gorm:"column:primaryKey;SETTING_ID" json:"SettingId"` //type:string       comment:                          version:2024-02-16 19:37
